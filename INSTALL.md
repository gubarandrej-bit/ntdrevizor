...
Каталог НТД актуален на **2026-08-12** (в том числе СП 6.13130.2025 с 29.06.2026 и СП 3.13130.2026 с 01.06.2026). Перед проверкой нажмите «Проверить актуальность» или просто запустите проверку — актуализация выполняется автоматически.
